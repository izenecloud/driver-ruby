...
jsonwidget.editor.getHelpButton = function (jsonref) {
    ...
    retval.id=helpid;
    retval.appendChild(document.createTextNode("[help]"));
    return retval;
}
...
jsonwidget.editor.getHideButton = function (jsonref) {
    ...
    retval.id=hideid;
    retval.appendChild(document.createTextNode("[hide]"));
    return retval;
}
...
jsonwidget.editor.getShowButton = function (jsonref) {
    ...
    retval.id=showid;
    retval.appendChild(document.createTextNode("[show]"));
...
jsonwidget.editor.getDeleteButton = function (jsonref) {
    ...
    retval.id=rmid;
    retval.appendChild(document.createTextNode("[del]"));
    return retval;
}            
...
jsonwidget.editor.getAddToSeqButton = function (jsonref) {
    ...
    addlink.appendChild(document.createTextNode("Add "+ itemname + " to " + nodename ));
    return addlink;
}
    ...
    if(jsonref.getType()=='map') {
        ...
        for(var i in schemap) {
            if(jsonref.node[i]==undefined || i == jsonref.schemaref.node.user_key) {
                numprops++;
                if(numprops == 1) {
                    retval.appendChild(document.createTextNode("Add property: "));
                }
                else {
...
jsonwidget.editor.confirmDelete = function (jsoneditobj, jsonref, el) {
    ...
    el.appendChild(document.createTextNode("delete? "));
    ...
    nobutton.onclick = function (event) {
        ...
        target.parentNode.innerHTML = "[del]";
        if(undefined != event.stopPropagation) {
            event.stopPropagation();
        }
        else {
